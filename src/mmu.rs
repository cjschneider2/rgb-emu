...
impl MMU {
    ...
    pub fn rb(&mut self, cpu: &Z80, addr: u16) -> u8 {
        match addr & 0xF000 {
            // Rom bank 0
            0x0000 => {
                if self.in_bios {
    ...
    pub fn rw(&mut self, cpu: &Z80, addr: u16) -> u16 {
    ...
    pub fn wb(&self, cpu: &Z80, addr: u16, val: u8) {
        // write 8-bit byte from memory
        unimplemented!();
    }
    pub fn ww(&self, cpu: &Z80, addr: u16, val: u16) {
